...
export class UsuarioService {
  private apiUrl = 'https://wattbook-5pt2.onrender.com/usuario';
  private apiUrlLibros = 'https://wattbook-5pt2.onrender.com/libros';
  constructor(private http: HttpClient) {
  }

  obtenerUsername(autorId: number | null): Observable<Perfil> {
    return this.http.get<Perfil>(`https://wattbook-5pt2.onrender.com/usuario/${autorId}/username`, { responseType: 'text' as 'json' });
  }
  ...
  obtenerUsernameMensaje(id: number | null): Observable<string> {
    return this.http.get(`https://wattbook-5pt2.onrender.com/usuario/${id}/mensaje`, { responseType: 'text' });
  }
