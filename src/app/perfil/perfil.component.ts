...
export class PerfilComponent implements OnInit {
  ...
  getAutoresIds(): void {
    this.http.get<any[]>(`https://wattbook-5pt2.onrender.com/seguidores/tusSeguidos/${this.idactual}`, { observe: 'response' })
      .subscribe({
        next: response => {
  ...
  getAutoresFavoritos(): void {
    this.autoresIds.forEach(id => {
      this.http.get<any>(`https://wattbook-5pt2.onrender.com/usuario/${id}/perfil`)
        .subscribe({
          next: user => {
  ...
  getSeguidoresId(): void {
    this.http.get<any[]>(`https://wattbook-5pt2.onrender.com/seguidores/listaSeguidores/${this.idactual}`, { observe: 'response' })
      .subscribe({
        next: response => {
  ...
  seguirUsuario(): void {
    ...
    const url = `https://wattbook-5pt2.onrender.com/seguidores/anyadirSeguidor`;
  ...
  dejarSeguirUsuario(): void {
    ...
    const url = `https://wattbook-5pt2.onrender.com/seguidores/eliminarSeguidor`;
